...
public class RandomGenerator {
    ...
    public static class Byte implements Generator<java.lang.Byte> {
        @Override public java.lang.Byte next() {
    ...
    public static class Short implements Generator<java.lang.Short> {
        @Override public java.lang.Short next() {
    ...
    public static class Integer implements Generator<java.lang.Integer> {
        ...
        @Override public java.lang.Integer next() {
    ...
    public static class Long implements Generator<java.lang.Long> {
        ...
        @Override public java.lang.Long next() {
            return new java.lang.Long(r.nextInt(mod));
        }
    }

    public static class Float implements Generator<java.lang.Float> {
        @Override public java.lang.Float next() {
    ...
    public static class Double implements Generator<java.lang.Double> {
        @Override public java.lang.Double next() {
